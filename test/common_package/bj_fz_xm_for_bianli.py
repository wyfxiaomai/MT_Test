...
class For_BianLi(Page):
        ...
        if for_9_flag == True and louceng_xpath != '' :
            for f9 in for_9_list[for_9_indexmin:for_9_indexmax]:
                ...
                if SearchCommon(self.driver).fangyuan_zongshu_ling(self.biaoqian()[0]) == False:
                    SearchCommon(self.driver).fangyuan_zongshu_ling_panduantishiyu(self.biaoqian()[1])
                    continue
                self.for_10(for_3_flag=for_3_flag,for_4_flag=for_4_flag,louling_xpath=louling_xpath,fy_xpath_qian_li=fy_xpath_qian_li,fy_xpath_hou_li=fy_xpath_hou_li,subwaylinesontext=subwaylinesontext,shouye_handle=shouye_handle,page_url=page_url,for_10_list=for_10_list,for_10_indexmin=for_10_indexmin, for_10_indexmax=for_10_indexmax, for_10_flag=for_10_flag)
    ...
    def for_10(self,for_3_flag,for_4_flag,louling_xpath,fy_xpath_qian_li,fy_xpath_hou_li,shouye_handle,page_url,for_10_flag, for_10_list,for_10_indexmin, for_10_indexmax,subwaylinesontext=''):
