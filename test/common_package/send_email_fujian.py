...
if __name__ == "__main__":
    ...
    from_addr = "1508430602@qq.com"  # 发件地址
    pwd = "englxtanrphjidaj"  # 发件地址的授权码，而非密码
    ...
    to_addr_list = ["wyfzgr@163.com"]  # 收件地址

    email_content = "麦田在线自动化测试"
    email_content_html = """
    <p>Python 邮件发送...</p>
    ...
    """
    email_subject = "麦田在线自动化测试报告"
    email_from = "1508430602@qq.com"
