...
class Bj_WeiTuo_TestCase(myunit.MyTest,Page):
    ...
    def test_1(self):
        """正确的输入内容"""
        self.open_url()
        WeiTuo(self.driver).send_text(xiaoqu_name='禹洲尊海',jushi=3,mianji=120,qiwangshoujia=300,lianxifangshi=15010561252)
    ...
    def test_3(self):
        """居室为空"""
        self.open_url()
        WeiTuo(self.driver).send_text(xiaoqu_name='禹洲尊海',jushi='',mianji=120,qiwangshoujia=300,lianxifangshi=15010561252)
        WeiTuo(self.driver).tijiao_click()
        sleep(1)
        warningText = WeiTuo(self.driver).get_warning_text()
        WeiTuo(self.driver).jieshou_warning()
    ...
    def test_4(self):
        """面积为空"""
        self.open_url()
        WeiTuo(self.driver).send_text(xiaoqu_name='禹洲尊海',jushi=3,mianji='',qiwangshoujia=300,lianxifangshi=15010561252)
        WeiTuo(self.driver).tijiao_click()
        sleep(1)
        warningText = WeiTuo(self.driver).get_warning_text()
        WeiTuo(self.driver).jieshou_warning()
    ...
    def test_5(self):
        """售价为空"""
        self.open_url()
        WeiTuo(self.driver).send_text(xiaoqu_name='禹洲尊海',jushi=3,mianji=120,qiwangshoujia='',lianxifangshi=15010561252)
        WeiTuo(self.driver).tijiao_click()
        sleep(1)
        warningText = WeiTuo(self.driver).get_warning_text()
        WeiTuo(self.driver).jieshou_warning()
    ...
    def test_6(self):
        """售价为空"""
        self.open_url()
        WeiTuo(self.driver).send_text(xiaoqu_name='禹洲尊海',jushi=3,mianji=120,qiwangshoujia=666,lianxifangshi='')
        WeiTuo(self.driver).tijiao_click()
        sleep(1)
        warningText = WeiTuo(self.driver).get_warning_text()
        WeiTuo(self.driver).jieshou_warning()
    ...
    def test_7(self):
        """输入不符合要求的手机号"""
        self.open_url()
        WeiTuo(self.driver).send_text(xiaoqu_name='禹洲尊海',jushi=3,mianji=120,qiwangshoujia=666,lianxifangshi='12345678901')
        #WeiTuo(self.driver).tijiao_click()
        sleep(1)
        warningText = WeiTuo(self.driver).get_warning_text()
        WeiTuo(self.driver).jieshou_warning()
    ...
    def test_8(self):
        """输入没有注册的手机号"""
        self.open_url()
        WeiTuo(self.driver).send_text(xiaoqu_name='禹洲尊海',jushi=3,mianji=120,qiwangshoujia=666,lianxifangshi='18351886391')
        #WeiTuo(self.driver).tijiao_click()
        sleep(1)
        warningText = WeiTuo(self.driver).get_warning_text()
        WeiTuo(self.driver).jieshou_warning()
